...
public class OscarBullhorn extends Client
{
    ...
    public boolean SendNotification()
    {
        ...
        <Marvin Type="Bullhorn">
            <Version>1.0</Version>
            <UniqueID>234234</UniqueID>
            <Key>sadfjklasdfjklsdafdsa</Key>
            <Port>5300</Port>
        </Marvin>
        ...
        LOGGER.log(Level.CONFIG, "Sending Oscar Bullhorn notification to: {0}:{1}", new Object[]{getAddress(), Integer.toString(getPort())});
