...
public class RoundLcdClockBuilder<B extends RoundLcdClockBuilder<B>> {
    ...
    public final RoundLcdClockBuilder minuteFiveColor(final Color MINUTE_FIVE_COLOR) {
        properties.put("minuteFiveColor", new SimpleObjectProperty<>(MINUTE_FIVE_COLOR));
        return this;
    }
