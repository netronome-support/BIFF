...
public class Lcd extends Control {
    ...
    public enum LcdDesign {
        ...
        LcdDesign(final String STYLE_CLASS) {
    ...
    public enum NumberSystem {
        ...
        NumberSystem(final String TEXT) {
            text = TEXT;
        }
    ...
    private void setValueVisible(final boolean VALUE_VISIBLE) {
    ...
    private synchronized void scheduleBlinkTask() {
        ...
        stopTask(periodicBlinkTask);
        periodicBlinkTask = periodicBlinkExecutorService.scheduleAtFixedRate(() -> Platform.runLater(() -> {
            if (isBlinking()) {
                toggleValue ^= true;
