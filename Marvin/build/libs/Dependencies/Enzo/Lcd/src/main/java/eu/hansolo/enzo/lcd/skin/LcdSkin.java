...
import eu.hansolo.enzo.lcd.Lcd.LcdFont;
...
public class LcdSkin extends SkinBase<Lcd> implements Skin<Lcd> {
    ...
    private void resize() {
        ...
        if (width > 0 && height > 0) {
            ...
            trendFalling.setCacheShape(true);
            ...
            trendSteady.setCacheShape(true);
            ...
            trendRising.setCacheShape(true);
