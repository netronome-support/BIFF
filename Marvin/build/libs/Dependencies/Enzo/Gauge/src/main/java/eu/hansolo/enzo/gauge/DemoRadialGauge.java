 ...
 * Time: 15:37
 */
public class DemoRadialGauge extends Application {
    ...
    @Override public void init() {
        leftControl = RadialGaugeBuilder.create()
                                        //.value(50)
                                        .title("Bright")
                                        .unit("Bright")
                                        .sections(new Section(35, 50, Color.LIME))
                                        .areas(new Section(80, 100, Color.rgb(255, 0, 0, 0.5)))
                                        .ledVisible(true)
                                        .ledColor(Color.CYAN)
                                        .build();

        rightControl = RadialGaugeBuilder.create()
                                         .title("Dark")
                                         .unit("Dark")
