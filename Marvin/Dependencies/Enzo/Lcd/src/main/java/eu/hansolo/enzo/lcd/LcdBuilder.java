...
public class LcdBuilder<B extends LcdBuilder<B>> {
    ...
    public final B textMode(final boolean TEXT_MODE) {
    ...
    public final B animationDurationInMs(final double ANIMATION_DURATION_IN_MS) {
    ...
    public final B keepAspect(final boolean KEEP_ASPECT) {
        properties.put("keepAspect", new SimpleBooleanProperty(KEEP_ASPECT));
        return (B) this;
    }

    public final B noFrame(final boolean NO_FRAME) {
    ...
    public final B crystalOverlayVisible(final boolean CRYSTAL_OVERLAY_VISIBLE) {
        properties.put("crystalOverlayVisible", new SimpleBooleanProperty(CRYSTAL_OVERLAY_VISIBLE));
        return (B) this;
    }

    public final B mainInnerShadowVisible(final boolean MAIN_INNER_SHADOW_VISIBLE) {
        properties.put("mainInnerShadowVisible", new SimpleBooleanProperty(MAIN_INNER_SHADOW_VISIBLE));
        return (B) this;
    }

    public final B foregroundShadowVisible(final boolean FOREGROUND_SHADOW_VISIBLE) {
    ...
    public final B minMeasuredValueDecimals(final int MIN_MEASURED_VALUE_DECIMALS) {
    ...
    public final B maxMeasuredValueDecimals(final int MAX_MEASURED_VALUE_DECIMALS) {
        properties.put("maxMeasuredValueDecimals", new SimpleIntegerProperty(MAX_MEASURED_VALUE_DECIMALS));
        return (B) this;
    }

    public final B lowerCenterText(final String LOWER_CENTER_TEXT) {
    ...
    public final B formerValueVisible(final boolean FORMER_VALUE_VISIBLE) {
    ...
    public final B titleVisible(final boolean TITLE_VISIBLE) {
    ...
    public final B thresholdBehaviorInverted(final boolean THRESHOLD_BEHAVIOR_INVERTED) {
        properties.put("thresholdBehaviorInverted", new SimpleBooleanProperty(THRESHOLD_BEHAVIOR_INVERTED));
        return (B) this;
    }

    public final B numberSystem(final Lcd.NumberSystem NUMBER_SYSTEM) {
    ...
    public final B titleFont(final String TITLE_FONT) {
        properties.put("titleFont", new SimpleStringProperty(TITLE_FONT));
        return (B) this;
    }

    public final B unitFont(final String UNIT_FONT) {
        properties.put("unitFont", new SimpleStringProperty(UNIT_FONT));
        return (B) this;
    }

    public final B valueFont(final Lcd.LcdFont VALUE_FONT) {
        properties.put("valueFont", new SimpleObjectProperty<Lcd.LcdFont>(VALUE_FONT));
        return (B) this;
    }

    public final B smallFont(final String SMALL_FONT) {
        properties.put("smallFont", new SimpleStringProperty(SMALL_FONT));
        return (B) this;
    }

    public final B lcdDesign(final LcdDesign LCD_DESIGN) {
        properties.put("lcdDesign", new SimpleObjectProperty<>(LCD_DESIGN));
        return (B) this;
    }
