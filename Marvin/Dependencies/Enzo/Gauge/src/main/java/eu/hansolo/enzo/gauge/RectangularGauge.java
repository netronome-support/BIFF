...
public class RectangularGauge extends Control {
    ...
    private RectangularGauge.TickLabelOrientation _tickLabelOrientation;
    private ObjectProperty<TickLabelOrientation>  tickLabelOrientation;
    private RectangularGauge.NumberFormat         _numberFormat;
    ...
    public final RectangularGauge.TickLabelOrientation getTickLabelOrientation() {
        return null == tickLabelOrientation ? _tickLabelOrientation : tickLabelOrientation.get();
    }
    public final void setTickLabelOrientation(final RectangularGauge.TickLabelOrientation TICK_LABEL_ORIENTATION) {
    ...
    public final RectangularGauge.NumberFormat getNumberFormat() {
        return null == numberFormat ? _numberFormat : numberFormat.get();
    }
    public final void setNumberFormat(final RectangularGauge.NumberFormat NUMBER_FORMAT) {
    ...
    public final ObjectProperty<Paint> tickMarkFillProperty() {
        if (null == tickMarkFill) {
            tickMarkFill = new StyleableObjectProperty<Paint>(Color.BLACK) {
                ...
                @Override public Object getBean() { return RectangularGauge.this; }
    ...
    // ******************** Style related *************************************
    @Override protected Skin createDefaultSkin() { return new RectangularGaugeSkin(this); }

    @Override public String getUserAgentStylesheet() { return getClass().getResource("rectangular-gauge.css").toExternalForm(); }
    ...
    private static class StyleableProperties {
        private static final CssMetaData<RectangularGauge, Paint> TICK_MARK_FILL =
            new CssMetaData<RectangularGauge, Paint>("-tick-mark-fill", (StyleConverter<?, Paint>) StyleConverter.getPaintConverter(), Color.BLACK) {
                ...
                @Override public StyleableProperty<Paint> getStyleableProperty(RectangularGauge gauge) {
