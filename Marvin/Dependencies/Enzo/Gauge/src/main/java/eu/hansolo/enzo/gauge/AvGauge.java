...
public class AvGauge extends Control {
    ...
    public AvGauge() {
        ...
        outerValue              = new DoublePropertyBase(minValue.get()) {
        ...
        innerValue              = new DoublePropertyBase(minValue.get()) {
            @Override public void set(final double VALUE) { super.set(clamp(minValue.get(), maxValue.get(), VALUE)); }
            @Override public Object getBean() { return AvGauge.this;}
    ...
    // ******************** CSS Meta Data *************************************
    @Override protected Skin createDefaultSkin() { return new AvGaugeSkin(this); }

    @Override public String getUserAgentStylesheet() { return getClass().getResource("avgauge.css").toExternalForm(); }
