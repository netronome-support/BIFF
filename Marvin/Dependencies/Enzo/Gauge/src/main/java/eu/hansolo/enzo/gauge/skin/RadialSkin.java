...
public class RadialSkin extends SkinBase<Radial> implements Skin<Radial> {
    ...
    private void registerListeners() {
        ...
        //getSkinnable().startAngleOneProperty().addListener(observable -> handleControlPropertyChanged("START_ANGLE"));
        //getSkinnable().angleRangeOneProperty().addListener(observable -> handleControlPropertyChanged("ANGLE_RANGE"));
