...
public class Demo extends Application {
    ...
    @Override public void init() {
        clock1 = ClockBuilder.create()
                             ...
                             .text("San Francisco")                             
                             .time(LocalTime.now().plus(Duration.of(-9, ChronoUnit.HOURS)))                             
                             .autoNightMode(false)
                             .build();
        clock2 = ClockBuilder.create()
                             ...
                             .nightMode(true)
                             .text("New York")
                             .time(LocalTime.now().plus(Duration.of(-6, ChronoUnit.HOURS)))
                             .autoNightMode(true)
                             .build();
        ...
        clock4 = ClockBuilder.create()
                             ...
                             .nightMode(true)
                             .text("Moskau")
                             .time(LocalTime.now().plus(Duration.of(3, ChronoUnit.HOURS)))
                             .autoNightMode(true)
                             .build();
        clock5 = ClockBuilder.create()
                             ...
                             .discreteSecond(true)
                             .text("Hongkong")
                             .time(LocalTime.now().plus(Duration.of(7, ChronoUnit.HOURS)))
                             .autoNightMode(true)
                             .build();
        clock6 = ClockBuilder.create()
                             ...
                             .discreteSecond(true)                             
                             .text("Sydney")
                             .time(LocalTime.now().plus(Duration.of(10, ChronoUnit.HOURS)))
                             .autoNightMode(true)
                             .build();
    }
